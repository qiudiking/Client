...
class sendMessage extends WsMessageBase
{
	 ...
	 * 设置需要发送的消息
	 * @param string                  $http_request_id
	 * @param \AtServer\WsMessageBase $wsMessageObj
	 */
	public static function setMessage( string $http_request_id,WsMessageBase $wsMessageObj)
	{
		self::$message[$http_request_id] = $wsMessageObj;
	}
